...
// Pure items used by both builds (DelegationKeys / display_memo / DTO array
// helpers). BUNDLE_NOTE_SLOTS is a plain governance const.
use crate::governance::BUNDLE_NOTE_SLOTS;
use crate::types::{Network, NoteInfo, VotingError, VotingHotkey};
#[cfg(feature = "native")]
...
pub(crate) fn redact_delegation_pczt_for_signer(pczt_bytes: &[u8]) -> Result<Vec<u8>, VotingError> {
